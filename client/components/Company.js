            ...
            <div className='col s12 m4 offset-m4'>
              <form ref='editCompanyForm' onSubmit={(e) => this.submitEdittedCompany(e, company.id)}>
                ...
                <div className='col s2' style={{marginTop: '10px'}}>
                  <button className='btn' type='submit' style={{ borderRadius: '3px', backgroundColor: `${this.props.assignedcompany.accent_color}`, color: `${this.props.assignedcompany.accent_text}`}}><i className="tiny material-icons confirm-icon">done</i></button>
                </div>
              </form>
            </div>
          </div>
